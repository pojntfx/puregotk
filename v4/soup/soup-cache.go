...
func (x *CacheClassGType) GoPointer() uintptr {
	return uintptr(unsafe.Pointer(x))
}

// OverrideGetCacheability sets the "get_cacheability" callback function.
func (x *CacheClassGType) OverrideGetCacheability(cb func(*Cache, *Message) Cacheability) {
	if cb == nil {
...
func (x *CacheClassGType) GetGetCacheability() func(*Cache, *Message) Cacheability {
