...
type AuthDomainClassGType struct {
...
func (x *AuthDomainClassGType) GoPointer() uintptr {
	return uintptr(unsafe.Pointer(x))
}

// OverrideAccepts sets the "accepts" callback function.
func (x *AuthDomainClassGType) OverrideAccepts(cb func(*AuthDomain, *ServerMessage, string) string) {
	if cb == nil {
		x.xAccepts = 0
	} else {
...
func (x *AuthDomainClassGType) GetAccepts() func(*AuthDomain, *ServerMessage, string) string {
	if x.xAccepts == 0 {
		return nil
	}
...
func (x *AuthDomainClassGType) OverrideChallenge(cb func(*AuthDomain, *ServerMessage) string) {
	if cb == nil {
		x.xChallenge = 0
	} else {
...
func (x *AuthDomainClassGType) GetChallenge() func(*AuthDomain, *ServerMessage) string {
	if x.xChallenge == 0 {
		return nil
	}
...
func (x *AuthDomainClassGType) OverrideCheckPassword(cb func(*AuthDomain, *ServerMessage, string, string) bool) {
	if cb == nil {
		x.xCheckPassword = 0
	} else {
...
func (x *AuthDomainClassGType) GetCheckPassword() func(*AuthDomain, *ServerMessage, string, string) bool {
