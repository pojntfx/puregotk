...
func (x *AuthClassGType) GoPointer() uintptr {
	return uintptr(unsafe.Pointer(x))
}

// OverrideUpdate sets the "update" callback function.
func (x *AuthClassGType) OverrideUpdate(cb func(*Auth, *Message, *glib.HashTable) bool) {
	if cb == nil {
		x.xUpdate = 0
	} else {
...
func (x *AuthClassGType) GetUpdate() func(*Auth, *Message, *glib.HashTable) bool {
	if x.xUpdate == 0 {
		return nil
	}
...
func (x *AuthClassGType) OverrideGetProtectionSpace(cb func(*Auth, *glib.Uri) *glib.SList) {
	if cb == nil {
...
func (x *AuthClassGType) GetGetProtectionSpace() func(*Auth, *glib.Uri) *glib.SList {
...
func (x *AuthClassGType) OverrideAuthenticate(cb func(*Auth, string, string)) {
	if cb == nil {
		x.xAuthenticate = 0
	} else {
...
func (x *AuthClassGType) GetAuthenticate() func(*Auth, string, string) {
...
func (x *AuthClassGType) OverrideIsAuthenticated(cb func(*Auth) bool) {
	if cb == nil {
...
func (x *AuthClassGType) GetIsAuthenticated() func(*Auth) bool {
...
func (x *AuthClassGType) OverrideGetAuthorization(cb func(*Auth, *Message) string) {
	if cb == nil {
...
func (x *AuthClassGType) GetGetAuthorization() func(*Auth, *Message) string {
...
func (x *AuthClassGType) OverrideIsReady(cb func(*Auth, *Message) bool) {
	if cb == nil {
		x.xIsReady = 0
	} else {
...
func (x *AuthClassGType) GetIsReady() func(*Auth, *Message) bool {
	if x.xIsReady == 0 {
		return nil
	}
...
func (x *AuthClassGType) OverrideCanAuthenticate(cb func(*Auth) bool) {
	if cb == nil {
...
func (x *AuthClassGType) GetCanAuthenticate() func(*Auth) bool {
