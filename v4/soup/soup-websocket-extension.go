...
type WebsocketExtensionClassGType struct {
...
func (x *WebsocketExtensionClassGType) GoPointer() uintptr {
	return uintptr(unsafe.Pointer(x))
}

// OverrideConfigure sets the "configure" callback function.
// called to configure the extension with the given parameters
func (x *WebsocketExtensionClassGType) OverrideConfigure(cb func(*WebsocketExtension, WebsocketConnectionType, *glib.HashTable) bool) {
	if cb == nil {
		x.xConfigure = 0
	} else {
...
// called to configure the extension with the given parameters
func (x *WebsocketExtensionClassGType) GetConfigure() func(*WebsocketExtension, WebsocketConnectionType, *glib.HashTable) bool {
	if x.xConfigure == 0 {
		return nil
	}
...
func (x *WebsocketExtensionClassGType) OverrideGetRequestParams(cb func(*WebsocketExtension) string) {
	if cb == nil {
...
//
//	It should include the parameters string starting with ';'
func (x *WebsocketExtensionClassGType) GetGetRequestParams() func(*WebsocketExtension) string {
...
//
//	It should include the parameters string starting with ';'
func (x *WebsocketExtensionClassGType) OverrideGetResponseParams(cb func(*WebsocketExtension) string) {
	if cb == nil {
...
//
//	It should include the parameters string starting with ';'
func (x *WebsocketExtensionClassGType) GetGetResponseParams() func(*WebsocketExtension) string {
...
func (x *WebsocketExtensionClassGType) OverrideProcessOutgoingMessage(cb func(*WebsocketExtension, byte, *glib.Bytes) *glib.Bytes) {
	if cb == nil {
...
//
//	before it's sent. Reserved bits of the header should be changed.
func (x *WebsocketExtensionClassGType) GetProcessOutgoingMessage() func(*WebsocketExtension, byte, *glib.Bytes) *glib.Bytes {
...
func (x *WebsocketExtensionClassGType) OverrideProcessIncomingMessage(cb func(*WebsocketExtension, byte, *glib.Bytes) *glib.Bytes) {
	if cb == nil {
...
//
//	after it's received. Reserved bits of the header should be cleared.
func (x *WebsocketExtensionClassGType) GetProcessIncomingMessage() func(*WebsocketExtension, byte, *glib.Bytes) *glib.Bytes {
