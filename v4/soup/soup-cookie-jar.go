...
type CookieJarClassGType struct {
...
func (x *CookieJarClassGType) GoPointer() uintptr {
	return uintptr(unsafe.Pointer(x))
}

// OverrideSave sets the "save" callback function.
func (x *CookieJarClassGType) OverrideSave(cb func(*CookieJar)) {
	if cb == nil {
		x.xSave = 0
	} else {
...
func (x *CookieJarClassGType) GetSave() func(*CookieJar) {
	if x.xSave == 0 {
		return nil
	}
...
func (x *CookieJarClassGType) OverrideIsPersistent(cb func(*CookieJar) bool) {
	if cb == nil {
		x.xIsPersistent = 0
	} else {
...
func (x *CookieJarClassGType) GetIsPersistent() func(*CookieJar) bool {
...
func (x *CookieJarClassGType) OverrideChanged(cb func(*CookieJar, *Cookie, *Cookie)) {
	if cb == nil {
		x.xChanged = 0
	} else {
...
func (x *CookieJarClassGType) GetChanged() func(*CookieJar, *Cookie, *Cookie) {
	if x.xChanged == 0 {
		return nil
	}
