...
func (x *ServerClassGType) GoPointer() uintptr {
	return uintptr(unsafe.Pointer(x))
}

// OverrideRequestStarted sets the "request_started" callback function.
func (x *ServerClassGType) OverrideRequestStarted(cb func(*Server, *ServerMessage)) {
	if cb == nil {
		x.xRequestStarted = 0
	} else {
...
func (x *ServerClassGType) GetRequestStarted() func(*Server, *ServerMessage) {
...
func (x *ServerClassGType) OverrideRequestRead(cb func(*Server, *ServerMessage)) {
	if cb == nil {
		x.xRequestRead = 0
	} else {
...
func (x *ServerClassGType) GetRequestRead() func(*Server, *ServerMessage) {
	if x.xRequestRead == 0 {
		return nil
	}
	var rawCallback func(ServerVarp uintptr, MsgVarp uintptr)
...
func (x *ServerClassGType) OverrideRequestFinished(cb func(*Server, *ServerMessage)) {
	if cb == nil {
...
func (x *ServerClassGType) GetRequestFinished() func(*Server, *ServerMessage) {
...
func (x *ServerClassGType) OverrideRequestAborted(cb func(*Server, *ServerMessage)) {
	if cb == nil {
		x.xRequestAborted = 0
	} else {
...
func (x *ServerClassGType) GetRequestAborted() func(*Server, *ServerMessage) {
