...
var xWebsocketClientPrepareHandshake func(uintptr, string, []string, uintptr)
...
func WebsocketClientPrepareHandshake(MsgVar *Message, OriginVar string, ProtocolsVar []string, SupportedExtensionsVar uintptr) {

	xWebsocketClientPrepareHandshake(MsgVar.GoPointer(), OriginVar, ProtocolsVar, SupportedExtensionsVar)

}

var xWebsocketClientVerifyHandshake func(uintptr, uintptr, **glib.List, **glib.Error) bool
...
func WebsocketClientVerifyHandshake(MsgVar *Message, SupportedExtensionsVar uintptr, AcceptedExtensionsVar **glib.List) (bool, error) {
	var cerr *glib.Error
...
var xWebsocketServerCheckHandshake func(uintptr, string, []string, uintptr, **glib.Error) bool
...
func WebsocketServerCheckHandshake(MsgVar *ServerMessage, OriginVar string, ProtocolsVar []string, SupportedExtensionsVar uintptr) (bool, error) {
	var cerr *glib.Error
...
var xWebsocketServerProcessHandshake func(uintptr, string, []string, uintptr, **glib.List) bool
...
func WebsocketServerProcessHandshake(MsgVar *ServerMessage, ExpectedOriginVar string, ProtocolsVar []string, SupportedExtensionsVar uintptr, AcceptedExtensionsVar **glib.List) bool {
