...
type HSTSEnforcerClassGType struct {
...
func (x *HSTSEnforcerClassGType) GoPointer() uintptr {
...
func (x *HSTSEnforcerClassGType) OverrideIsPersistent(cb func(*HSTSEnforcer) bool) {
	if cb == nil {
		x.xIsPersistent = 0
	} else {
...
// The @is_persistent function advertises whether the enforcer is persistent or
// whether changes made to it will be lost when the underlying [class@Session] is finished.
func (x *HSTSEnforcerClassGType) GetIsPersistent() func(*HSTSEnforcer) bool {
...
// policies.
func (x *HSTSEnforcerClassGType) OverrideHasValidPolicy(cb func(*HSTSEnforcer, string) bool) {
	if cb == nil {
		x.xHasValidPolicy = 0
	} else {
...
// chain up to the @has_valid_policy in the parent class to check, for instance, for runtime
// policies.
func (x *HSTSEnforcerClassGType) GetHasValidPolicy() func(*HSTSEnforcer, string) bool {
...
func (x *HSTSEnforcerClassGType) OverrideChanged(cb func(*HSTSEnforcer, *HSTSPolicy, *HSTSPolicy)) {
	if cb == nil {
		x.xChanged = 0
	} else {
...
// The class closure for the #SoupHSTSEnforcer::changed signal.
func (x *HSTSEnforcerClassGType) GetChanged() func(*HSTSEnforcer, *HSTSPolicy, *HSTSPolicy) {
	if x.xChanged == 0 {
		return nil
	}
