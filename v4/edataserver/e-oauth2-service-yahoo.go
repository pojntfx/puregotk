...
type OAuth2ServiceYahooClassGType struct {
	_ structs.HostLayout

	ParentClass OAuth2ServiceBaseClassGType
}

func (x *OAuth2ServiceYahooClassGType) GoPointer() uintptr {
	return uintptr(unsafe.Pointer(x))
}

type OAuth2ServiceYahoo struct {
	OAuth2ServiceBase
}

var xOAuth2ServiceYahooGLibType func() types.GType

func OAuth2ServiceYahooGLibType() types.GType {
	return xOAuth2ServiceYahooGLibType()
}

func OAuth2ServiceYahooNewFromInternalPtr(ptr uintptr) *OAuth2ServiceYahoo {
	cls := &OAuth2ServiceYahoo{}
	cls.Ptr = ptr
	return cls
}

func (c *OAuth2ServiceYahoo) GoPointer() uintptr {
	if c == nil {
		return 0
	}
	return c.Ptr
...
func (c *OAuth2ServiceYahoo) SetGoPointer(ptr uintptr) {
	c.Ptr = ptr
}
...
func (x *OAuth2ServiceYahoo) CanProcess(SourceVar *Source) bool {
...
func (x *OAuth2ServiceYahoo) DeleteTokenSync(SourceVar *Source, CancellableVar *gio.Cancellable) (bool, error) {
	var cerr *glib.Error
...
func (x *OAuth2ServiceYahoo) DupCredentialsPrompterCookiesSync(SourceVar *Source, CancellableVar *gio.Cancellable) *glib.SList {
...
func (x *OAuth2ServiceYahoo) ExtractAuthorizationCode(SourceVar *Source, PageTitleVar string, PageUriVar string, PageContentVar string, OutAuthorizationCodeVar *string) bool {
...
func (x *OAuth2ServiceYahoo) ExtractErrorMessage(SourceVar *Source, PageTitleVar string, PageUriVar string, PageContentVar string, OutErrorMessageVar *string) bool {
...
func (x *OAuth2ServiceYahoo) GetAccessTokenSync(SourceVar *Source, RefSourceVar *OAuth2ServiceRefSourceFunc, RefSourceUserDataVar uintptr, OutAccessTokenVar *string, OutExpiresInVar *int, CancellableVar *gio.Cancellable) (bool, error) {
	var cerr *glib.Error
...
// in the page).
func (x *OAuth2ServiceYahoo) GetAuthenticationPolicy(SourceVar *Source, UriVar string) OAuth2ServiceNavigationPolicy {

	cret := XEOauth2ServiceGetAuthenticationPolicy(x.GoPointer(), SourceVar.GoPointer(), UriVar)
	return cret
}

func (x *OAuth2ServiceYahoo) GetAuthenticationUri(SourceVar *Source) string {

	cret := XEOauth2ServiceGetAuthenticationUri(x.GoPointer(), SourceVar.GoPointer())
	return cret
}

func (x *OAuth2ServiceYahoo) GetClientId(SourceVar *Source) string {

	cret := XEOauth2ServiceGetClientId(x.GoPointer(), SourceVar.GoPointer())
	return cret
}

func (x *OAuth2ServiceYahoo) GetClientSecret(SourceVar *Source) string {
...
func (x *OAuth2ServiceYahoo) GetDisplayName() string {

	cret := XEOauth2ServiceGetDisplayName(x.GoPointer())
	return cret
}

func (x *OAuth2ServiceYahoo) GetFlags() uint32 {
...
func (x *OAuth2ServiceYahoo) GetName() string {
...
func (x *OAuth2ServiceYahoo) GetRedirectUri(SourceVar *Source) string {

	cret := XEOauth2ServiceGetRedirectUri(x.GoPointer(), SourceVar.GoPointer())
	return cret
}

func (x *OAuth2ServiceYahoo) GetRefreshUri(SourceVar *Source) string {
...
// The default implementation is tried always as the first and when it fails, then
// the descendant's implementation is called.
func (x *OAuth2ServiceYahoo) GuessCanProcess(ProtocolVar string, HostnameVar string) bool {
...
// is replaced.
func (x *OAuth2ServiceYahoo) PrepareAuthenticationUriQuery(SourceVar *Source, UriQueryVar *glib.HashTable) {
...
// strings, which will be freed together with the hash table or when the key
// is replaced.
func (x *OAuth2ServiceYahoo) PrepareGetTokenForm(SourceVar *Source, AuthorizationCodeVar string, FormVar *glib.HashTable) {
...
func (x *OAuth2ServiceYahoo) PrepareGetTokenMessage(SourceVar *Source, MessageVar *soup.Message) {
...
// strings, which will be freed together with the hash table or when the key
// is replaced.
func (x *OAuth2ServiceYahoo) PrepareRefreshTokenForm(SourceVar *Source, RefreshTokenVar string, FormVar *glib.HashTable) {
...
// The default implementation does nothing with the @message.
func (x *OAuth2ServiceYahoo) PrepareRefreshTokenMessage(SourceVar *Source, MessageVar *soup.Message) {
...
func (x *OAuth2ServiceYahoo) ReceiveAndStoreTokenSync(SourceVar *Source, AuthorizationCodeVar string, RefSourceVar *OAuth2ServiceRefSourceFunc, RefSourceUserDataVar uintptr, CancellableVar *gio.Cancellable) (bool, error) {
	var cerr *glib.Error
...
// store on success.
func (x *OAuth2ServiceYahoo) RefreshAndStoreTokenSync(SourceVar *Source, RefreshTokenVar string, RefSourceVar *OAuth2ServiceRefSourceFunc, RefSourceUserDataVar uintptr, CancellableVar *gio.Cancellable) (bool, error) {
	var cerr *glib.Error
