...
type OAuth2ServiceGoogleClassGType struct {
	_ structs.HostLayout

	ParentClass OAuth2ServiceBaseClassGType
}

func (x *OAuth2ServiceGoogleClassGType) GoPointer() uintptr {
	return uintptr(unsafe.Pointer(x))
}

type OAuth2ServiceGoogle struct {
	OAuth2ServiceBase
}

var xOAuth2ServiceGoogleGLibType func() types.GType

func OAuth2ServiceGoogleGLibType() types.GType {
	return xOAuth2ServiceGoogleGLibType()
}

func OAuth2ServiceGoogleNewFromInternalPtr(ptr uintptr) *OAuth2ServiceGoogle {
	cls := &OAuth2ServiceGoogle{}
	cls.Ptr = ptr
	return cls
}

func (c *OAuth2ServiceGoogle) GoPointer() uintptr {
	if c == nil {
		return 0
	}
	return c.Ptr
...
func (c *OAuth2ServiceGoogle) SetGoPointer(ptr uintptr) {
	c.Ptr = ptr
}
...
func (x *OAuth2ServiceGoogle) CanProcess(SourceVar *Source) bool {
...
func (x *OAuth2ServiceGoogle) DeleteTokenSync(SourceVar *Source, CancellableVar *gio.Cancellable) (bool, error) {
	var cerr *glib.Error
...
func (x *OAuth2ServiceGoogle) DupCredentialsPrompterCookiesSync(SourceVar *Source, CancellableVar *gio.Cancellable) *glib.SList {
...
func (x *OAuth2ServiceGoogle) ExtractAuthorizationCode(SourceVar *Source, PageTitleVar string, PageUriVar string, PageContentVar string, OutAuthorizationCodeVar *string) bool {
...
func (x *OAuth2ServiceGoogle) ExtractErrorMessage(SourceVar *Source, PageTitleVar string, PageUriVar string, PageContentVar string, OutErrorMessageVar *string) bool {
...
func (x *OAuth2ServiceGoogle) GetAccessTokenSync(SourceVar *Source, RefSourceVar *OAuth2ServiceRefSourceFunc, RefSourceUserDataVar uintptr, OutAccessTokenVar *string, OutExpiresInVar *int, CancellableVar *gio.Cancellable) (bool, error) {
	var cerr *glib.Error
...
// in the page).
func (x *OAuth2ServiceGoogle) GetAuthenticationPolicy(SourceVar *Source, UriVar string) OAuth2ServiceNavigationPolicy {

	cret := XEOauth2ServiceGetAuthenticationPolicy(x.GoPointer(), SourceVar.GoPointer(), UriVar)
	return cret
}

func (x *OAuth2ServiceGoogle) GetAuthenticationUri(SourceVar *Source) string {

	cret := XEOauth2ServiceGetAuthenticationUri(x.GoPointer(), SourceVar.GoPointer())
	return cret
}

func (x *OAuth2ServiceGoogle) GetClientId(SourceVar *Source) string {

	cret := XEOauth2ServiceGetClientId(x.GoPointer(), SourceVar.GoPointer())
	return cret
}

func (x *OAuth2ServiceGoogle) GetClientSecret(SourceVar *Source) string {
...
func (x *OAuth2ServiceGoogle) GetDisplayName() string {

	cret := XEOauth2ServiceGetDisplayName(x.GoPointer())
	return cret
}

func (x *OAuth2ServiceGoogle) GetFlags() uint32 {
...
func (x *OAuth2ServiceGoogle) GetName() string {
...
func (x *OAuth2ServiceGoogle) GetRedirectUri(SourceVar *Source) string {

	cret := XEOauth2ServiceGetRedirectUri(x.GoPointer(), SourceVar.GoPointer())
	return cret
}

func (x *OAuth2ServiceGoogle) GetRefreshUri(SourceVar *Source) string {
...
// The default implementation is tried always as the first and when it fails, then
// the descendant's implementation is called.
func (x *OAuth2ServiceGoogle) GuessCanProcess(ProtocolVar string, HostnameVar string) bool {
...
// is replaced.
func (x *OAuth2ServiceGoogle) PrepareAuthenticationUriQuery(SourceVar *Source, UriQueryVar *glib.HashTable) {
...
// strings, which will be freed together with the hash table or when the key
// is replaced.
func (x *OAuth2ServiceGoogle) PrepareGetTokenForm(SourceVar *Source, AuthorizationCodeVar string, FormVar *glib.HashTable) {
...
func (x *OAuth2ServiceGoogle) PrepareGetTokenMessage(SourceVar *Source, MessageVar *soup.Message) {
...
// strings, which will be freed together with the hash table or when the key
// is replaced.
func (x *OAuth2ServiceGoogle) PrepareRefreshTokenForm(SourceVar *Source, RefreshTokenVar string, FormVar *glib.HashTable) {
...
// The default implementation does nothing with the @message.
func (x *OAuth2ServiceGoogle) PrepareRefreshTokenMessage(SourceVar *Source, MessageVar *soup.Message) {
...
func (x *OAuth2ServiceGoogle) ReceiveAndStoreTokenSync(SourceVar *Source, AuthorizationCodeVar string, RefSourceVar *OAuth2ServiceRefSourceFunc, RefSourceUserDataVar uintptr, CancellableVar *gio.Cancellable) (bool, error) {
	var cerr *glib.Error
...
// store on success.
func (x *OAuth2ServiceGoogle) RefreshAndStoreTokenSync(SourceVar *Source, RefreshTokenVar string, RefSourceVar *OAuth2ServiceRefSourceFunc, RefSourceUserDataVar uintptr, CancellableVar *gio.Cancellable) (bool, error) {
	var cerr *glib.Error
