...
var xGLContextGetRequiredVersion func(uintptr, uintptr, uintptr)
...
func (x *GLContext) GetRequiredVersion(MajorVar *int, MinorVar *int) {
	...
	xGLContextGetRequiredVersion(x.GoPointer(), uintptr(unsafe.Pointer(MajorVar)), uintptr(unsafe.Pointer(MinorVar)))
...
var xGLContextGetVersion func(uintptr, uintptr, uintptr)
...
func (x *GLContext) GetVersion(MajorVar *int, MinorVar *int) {
	...
	xGLContextGetVersion(x.GoPointer(), uintptr(unsafe.Pointer(MajorVar)), uintptr(unsafe.Pointer(MinorVar)))
