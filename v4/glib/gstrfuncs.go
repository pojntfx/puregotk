...
var xAsciiStringToSigned func(string, uint, int64, int64, uintptr, **Error) bool
...
func AsciiStringToSigned(StrVar string, BaseVar uint, MinVar int64, MaxVar int64, OutNumVar *int64) (bool, error) {
	...
	cret := xAsciiStringToSigned(StrVar, BaseVar, MinVar, MaxVar, uintptr(unsafe.Pointer(OutNumVar)), &cerr)
	if cerr == nil {
		return cret, nil
	}
	return cret, cerr
...
var xAsciiStringToUnsigned func(string, uint, uint64, uint64, uintptr, **Error) bool
...
func AsciiStringToUnsigned(StrVar string, BaseVar uint, MinVar uint64, MaxVar uint64, OutNumVar *uint64) (bool, error) {
	...
	cret := xAsciiStringToUnsigned(StrVar, BaseVar, MinVar, MaxVar, uintptr(unsafe.Pointer(OutNumVar)), &cerr)
	if cerr == nil {
		return cret, nil
	}
	return cret, cerr
...
var xAsciiStrtod func(string, uintptr) float64
...
func AsciiStrtod(NptrVar string, EndptrVar *string) float64 {
	...
	cret := xAsciiStrtod(NptrVar, uintptr(unsafe.Pointer(EndptrVar)))
	return cret
}

var xAsciiStrtoll func(string, uintptr, uint) int64
...
func AsciiStrtoll(NptrVar string, EndptrVar *string, BaseVar uint) int64 {
	...
	cret := xAsciiStrtoll(NptrVar, uintptr(unsafe.Pointer(EndptrVar)), BaseVar)
	return cret
}

var xAsciiStrtoull func(string, uintptr, uint) uint64
...
func AsciiStrtoull(NptrVar string, EndptrVar *string, BaseVar uint) uint64 {
	...
	cret := xAsciiStrtoull(NptrVar, uintptr(unsafe.Pointer(EndptrVar)), BaseVar)
	return cret
}
...
var xStrTokenizeAndFold func(string, string, uintptr) []string
...
func StrTokenizeAndFold(StringVar string, TranslitLocaleVar string, AsciiAlternatesVar *[]string) []string {
	...
	cret := xStrTokenizeAndFold(StringVar, TranslitLocaleVar, uintptr(unsafe.Pointer(AsciiAlternatesVar)))
	return cret
}
...
var xStrtod func(string, uintptr) float64
...
func Strtod(NptrVar string, EndptrVar *string) float64 {
	...
	cret := xStrtod(NptrVar, uintptr(unsafe.Pointer(EndptrVar)))
	return cret
}
