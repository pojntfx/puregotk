...
var xBase64Decode func(string, uintptr) uintptr
...
func Base64Decode(TextVar string, OutLenVar *uint) uintptr {
	...
	cret := xBase64Decode(TextVar, uintptr(unsafe.Pointer(OutLenVar)))
	return cret
}
...
var xBase64DecodeStep func([]byte, uint, uintptr, int, uint) uint
...
func Base64DecodeStep(InVar []byte, LenVar uint, OutVar *[]byte, StateVar int, SaveVar uint) uint {
	...
	cret := xBase64DecodeStep(InVar, LenVar, uintptr(unsafe.Pointer(OutVar)), StateVar, SaveVar)
	return cret
}
...
func Base64EncodeClose(BreakLinesVar bool, OutVar *[]byte, StateVar int, SaveVar int) uint {
	...
	cret := xBase64EncodeClose(BreakLinesVar, uintptr(unsafe.Pointer(OutVar)), StateVar, SaveVar)
	return cret
}

var xBase64EncodeStep func([]byte, uint, bool, uintptr, int, int) uint
...
func Base64EncodeStep(InVar []byte, LenVar uint, BreakLinesVar bool, OutVar *[]byte, StateVar int, SaveVar int) uint {
	...
	cret := xBase64EncodeStep(InVar, LenVar, BreakLinesVar, uintptr(unsafe.Pointer(OutVar)), StateVar, SaveVar)
	return cret
}
