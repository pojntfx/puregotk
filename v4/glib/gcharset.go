...
var xGetCharset func(uintptr) bool
...
func GetCharset(CharsetVar *string) bool {
	...
	cret := xGetCharset(uintptr(unsafe.Pointer(CharsetVar)))
	return cret
}
...
var xGetConsoleCharset func(uintptr) bool
...
func GetConsoleCharset(CharsetVar *string) bool {
	...
	cret := xGetConsoleCharset(uintptr(unsafe.Pointer(CharsetVar)))
	return cret
}
