...
var xScriptIterGetRange func(uintptr, uintptr, uintptr, uintptr)
...
func (x *ScriptIter) GetRange(StartVar *string, EndVar *string, ScriptVar *Script) {
	...
	xScriptIterGetRange(x.GoPointer(), uintptr(unsafe.Pointer(StartVar)), uintptr(unsafe.Pointer(EndVar)), uintptr(unsafe.Pointer(ScriptVar)))
