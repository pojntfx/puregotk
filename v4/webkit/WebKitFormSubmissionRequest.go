...
type FormSubmissionRequestClassGType struct {
	_ structs.HostLayout

	ParentClass gobject.ObjectClassGType
}

func (x *FormSubmissionRequestClassGType) GoPointer() uintptr {
...
var xFormSubmissionRequestListTextFields func(uintptr, *uintptr, *uintptr) bool
...
func (x *FormSubmissionRequest) ListTextFields(FieldNamesVar *uintptr, FieldValuesVar *uintptr) bool {
