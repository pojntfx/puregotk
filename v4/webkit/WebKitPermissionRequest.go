...
type PermissionRequestInterfaceGType struct {
...
func (x *PermissionRequestInterfaceGType) GoPointer() uintptr {
	return uintptr(unsafe.Pointer(x))
}

// OverrideAllow sets the "allow" callback function.
func (x *PermissionRequestInterfaceGType) OverrideAllow(cb func(PermissionRequest)) {
	if cb == nil {
		x.xAllow = 0
	} else {
...
func (x *PermissionRequestInterfaceGType) GetAllow() func(PermissionRequest) {
	if x.xAllow == 0 {
		return nil
	}
...
func (x *PermissionRequestInterfaceGType) OverrideDeny(cb func(PermissionRequest)) {
	if cb == nil {
		x.xDeny = 0
	} else {
...
func (x *PermissionRequestInterfaceGType) GetDeny() func(PermissionRequest) {
	if x.xDeny == 0 {
		return nil
	}
	var rawCallback func(RequestVarp uintptr)
