...
type InputMethodContextClassGType struct {
...
func (x *InputMethodContextClassGType) GoPointer() uintptr {
	return uintptr(unsafe.Pointer(x))
}

// OverridePreeditStarted sets the "preedit_started" callback function.
func (x *InputMethodContextClassGType) OverridePreeditStarted(cb func(*InputMethodContext)) {
	if cb == nil {
		x.xPreeditStarted = 0
	} else {
...
func (x *InputMethodContextClassGType) GetPreeditStarted() func(*InputMethodContext) {
...
func (x *InputMethodContextClassGType) OverridePreeditChanged(cb func(*InputMethodContext)) {
	if cb == nil {
		x.xPreeditChanged = 0
	} else {
...
func (x *InputMethodContextClassGType) GetPreeditChanged() func(*InputMethodContext) {
...
func (x *InputMethodContextClassGType) OverridePreeditFinished(cb func(*InputMethodContext)) {
	if cb == nil {
...
func (x *InputMethodContextClassGType) GetPreeditFinished() func(*InputMethodContext) {
...
func (x *InputMethodContextClassGType) OverrideCommitted(cb func(*InputMethodContext, string)) {
	if cb == nil {
		x.xCommitted = 0
	} else {
...
func (x *InputMethodContextClassGType) GetCommitted() func(*InputMethodContext, string) {
	if x.xCommitted == 0 {
		return nil
	}
...
func (x *InputMethodContextClassGType) OverrideDeleteSurrounding(cb func(*InputMethodContext, int, uint)) {
	if cb == nil {
...
func (x *InputMethodContextClassGType) GetDeleteSurrounding() func(*InputMethodContext, int, uint) {
...
func (x *InputMethodContextClassGType) OverrideSetEnablePreedit(cb func(*InputMethodContext, bool)) {
	if cb == nil {
...
//
//	control the use of the preedit string.
func (x *InputMethodContextClassGType) GetSetEnablePreedit() func(*InputMethodContext, bool) {
...
func (x *InputMethodContextClassGType) OverrideGetPreedit(cb func(*InputMethodContext, *string, **glib.List, *uint)) {
	if cb == nil {
		x.xGetPreedit = 0
	} else {
...
//	other compositions from multiple sequential key presses should override
//	this method to provide feedback.
func (x *InputMethodContextClassGType) GetGetPreedit() func(*InputMethodContext, *string, **glib.List, *uint) {
	if x.xGetPreedit == 0 {
		return nil
	}
...
func (x *InputMethodContextClassGType) OverrideFilterKeyEvent(cb func(*InputMethodContext, *gdk.Event) bool) {
	if cb == nil {
		x.xFilterKeyEvent = 0
	} else {
...
//	resulting text back to the editable element. Alternatively, %FALSE may be
//	returned to indicate that the event wasn’t handled by the input method.
func (x *InputMethodContextClassGType) GetFilterKeyEvent() func(*InputMethodContext, *gdk.Event) bool {
...
func (x *InputMethodContextClassGType) OverrideNotifyFocusIn(cb func(*InputMethodContext)) {
	if cb == nil {
		x.xNotifyFocusIn = 0
	} else {
...
//
//	an editable element of the #WebKitWebView has gained focus.
func (x *InputMethodContextClassGType) GetNotifyFocusIn() func(*InputMethodContext) {
...
func (x *InputMethodContextClassGType) OverrideNotifyFocusOut(cb func(*InputMethodContext)) {
	if cb == nil {
		x.xNotifyFocusOut = 0
	} else {
...
//
//	an editable element of the #WebKitWebView has lost focus.
func (x *InputMethodContextClassGType) GetNotifyFocusOut() func(*InputMethodContext) {
...
//	the client window.
func (x *InputMethodContextClassGType) OverrideNotifyCursorArea(cb func(*InputMethodContext, int, int, int, int)) {
	if cb == nil {
...
//	to inform the input method of the current cursor location relative to
//	the client window.
func (x *InputMethodContextClassGType) GetNotifyCursorArea() func(*InputMethodContext, int, int, int, int) {
...
//	the preedit string.
func (x *InputMethodContextClassGType) OverrideNotifySurrounding(cb func(*InputMethodContext, string, uint, uint, uint)) {
	if cb == nil {
...
//	update the context surrounding the cursor. The provided text should not include
//	the preedit string.
func (x *InputMethodContextClassGType) GetNotifySurrounding() func(*InputMethodContext, string, uint, uint, uint) {
...
func (x *InputMethodContextClassGType) OverrideReset(cb func(*InputMethodContext)) {
	if cb == nil {
		x.xReset = 0
	} else {
...
//	requires a reset. An input method that implements preediting
//	should override this method to clear the preedit state on reset.
func (x *InputMethodContextClassGType) GetReset() func(*InputMethodContext) {
	if x.xReset == 0 {
		return nil
	}
	var rawCallback func(ContextVarp uintptr)
...
func (x *InputMethodContextClassGType) OverrideWebkitReserved0(cb func()) {
	if cb == nil {
...
func (x *InputMethodContextClassGType) GetWebkitReserved0() func() {
...
func (x *InputMethodContextClassGType) OverrideWebkitReserved1(cb func()) {
	if cb == nil {
...
func (x *InputMethodContextClassGType) GetWebkitReserved1() func() {
...
func (x *InputMethodContextClassGType) OverrideWebkitReserved2(cb func()) {
	if cb == nil {
...
func (x *InputMethodContextClassGType) GetWebkitReserved2() func() {
...
func (x *InputMethodContextClassGType) OverrideWebkitReserved3(cb func()) {
	if cb == nil {
...
func (x *InputMethodContextClassGType) GetWebkitReserved3() func() {
...
func (x *InputMethodContextClassGType) OverrideWebkitReserved4(cb func()) {
	if cb == nil {
...
func (x *InputMethodContextClassGType) GetWebkitReserved4() func() {
...
func (x *InputMethodContextClassGType) OverrideWebkitReserved5(cb func()) {
	if cb == nil {
...
func (x *InputMethodContextClassGType) GetWebkitReserved5() func() {
...
func (x *InputMethodContextClassGType) OverrideWebkitReserved6(cb func()) {
	if cb == nil {
...
func (x *InputMethodContextClassGType) GetWebkitReserved6() func() {
...
func (x *InputMethodContextClassGType) OverrideWebkitReserved7(cb func()) {
	if cb == nil {
...
func (x *InputMethodContextClassGType) GetWebkitReserved7() func() {
...
func (x *InputMethodContextClassGType) OverrideWebkitReserved8(cb func()) {
	if cb == nil {
...
func (x *InputMethodContextClassGType) GetWebkitReserved8() func() {
...
func (x *InputMethodContextClassGType) OverrideWebkitReserved9(cb func()) {
	if cb == nil {
...
func (x *InputMethodContextClassGType) GetWebkitReserved9() func() {
...
func (x *InputMethodContextClassGType) OverrideWebkitReserved10(cb func()) {
	if cb == nil {
...
func (x *InputMethodContextClassGType) GetWebkitReserved10() func() {
...
func (x *InputMethodContextClassGType) OverrideWebkitReserved11(cb func()) {
	if cb == nil {
...
func (x *InputMethodContextClassGType) GetWebkitReserved11() func() {
...
func (x *InputMethodContextClassGType) OverrideWebkitReserved12(cb func()) {
	if cb == nil {
...
func (x *InputMethodContextClassGType) GetWebkitReserved12() func() {
...
func (x *InputMethodContextClassGType) OverrideWebkitReserved13(cb func()) {
	if cb == nil {
...
func (x *InputMethodContextClassGType) GetWebkitReserved13() func() {
...
func (x *InputMethodContextClassGType) OverrideWebkitReserved14(cb func()) {
	if cb == nil {
...
func (x *InputMethodContextClassGType) GetWebkitReserved14() func() {
...
func (x *InputMethodContextClassGType) OverrideWebkitReserved15(cb func()) {
	if cb == nil {
...
func (x *InputMethodContextClassGType) GetWebkitReserved15() func() {
